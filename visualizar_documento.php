...
<head>
	...
	<link rel="stylesheet" type="text/css" href="css/impressao_doc.css">
</head>
<body>
	<br>
<div class="icons">
	<a href="imprimir_doc.php?identificador=<?php echo $identificador?>" target="_blank"> 
		<i class="fas fa-print"></i>
	</a>
	</div>
<div class="container_principal_imp">
	<p>Registro Interno</p>
	<br>
	...
	<div class="planos">
		<label>
			...
			<b><?php echo $rows_planos['cod_plano'] . " - " . $rows_planos['descricao'] . ": R$" . $rows_planos['total_plano'] ?>
				<br>
				<?php
	...
	<?php if ($rows = mysqli_num_rows($result) > 0) {
		...
		<center>
			<div class="totalizadores">
				<label><b>TOTALIZADORES</b></label><BR>
